				...
				<td><?=$rows['tanggal_lahir']?></td>
			      <td>
					<!-- <a href="update.php?id=<?=$rows['id']?>" class="btn btn-success">Update</a>
					  ...
					  <a href="update.php?id=<?=$rows['id_pelanggan']?>" 
			      	     class="btn btn-success">Update</a>

			      	  <a href="php/delete.php?id=<?=$rows['id_pelanggan']?>" 
			      	     class="btn btn-danger" onclick="return confirm('Apakah kamu yakin ingin menghapus?')">Delete</a>
